        ...
        <div id="gallery-card">
          <div id="vmarine" className="modal-card">
            ...
            <div className="modal-info">
              ...
              <div className="modal-description">
                <ul>
                  <li>
                    A place where students can discuss and share their
                    ideas,thoughts and many more.
                  </li>
                  <li>Designed with HTML5, CSS3, Bootstrap, and ReactJS.</li>
                </ul>
              </div>
          ...
          <div id="agualuz" className="modal-card">
            ...
            <div className="modal-info">
              ...
              <div className="modal-description">
                <ul>
                  <li>
                    Prototype website to get all the basic knowledge about web
                    development and mostly javascript related stuff.
                  </li>
                  <li>
                    Developed with HTML5, CSS3, Bootstrap, , Parallax Effect,
          ...
          <div id="todolist" className="modal-card">
            ...
            <div className="modal-info">
              ...
              <div className="modal-description">
                <ul>
                  <li>A to-do list to keep track of goals.</li>
                  <li>Developed with HTML5, CSS3, Bootstrap and ReactJS.</li>
                </ul>
              </div>
              <div className="modal-bottom">
